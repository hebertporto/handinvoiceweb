...
const faqs = [
  [
    {
      question: 'Does HandInvoice handle VAT?',
      answer:
    ...
    {
      question: 'How do I apply for a job at HandInvoice?',
      answer:
  ...
  [
    {
      ...
      answer:
        'HandInvoice is just a software application, ultimately your books are your responsibility.',
    },
    {
      question:
        'HandInvoice sounds horrible but why do I still feel compelled to purchase?',
      answer:
        'This is the power of excellent visual design. You just can’t resist it, no matter how poorly it actually functions.',
    },
    {
      question:
        'I found other companies called HandInvoice, are you sure you can use this name?',
      answer:
